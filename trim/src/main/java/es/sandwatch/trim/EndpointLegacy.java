...
public class EndpointLegacy{
     ...
     */
    public EndpointLegacy(@NotNull String url, @NotNull Class model){
     ...
     */
    public EndpointLegacy(@NotNull String url, @NotNull Class model, @NotNull Map<String, String> headers){
        this.url = url;
        this.model = model;
     ...
     * @return this EndpointLegacy.
     */
    EndpointLegacy addHeader(@NotNull String header, @NotNull String value){
